...
public class CallFunctionRemoteValueTest : BiDiTestFixture
{
    ...
    public async Task CanCallFunctionAndReturnUndefined()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<UndefinedRemoteValue>());
    }
    ...
    public async Task CanCallFunctionAndReturnNull()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<NullRemoteValue>());
    }
    ...
    public async Task CanCallFunctionAndReturnTrue()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<BooleanRemoteValue>());
        Assert.That(((BooleanRemoteValue)response.AsSuccess().Result).Value, Is.True);
    }
    ...
    public async Task CanCallFunctionAndReturnFalse()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<BooleanRemoteValue>());
        Assert.That(((BooleanRemoteValue)response.AsSuccess().Result).Value, Is.False);
    }
    ...
    public async Task CanCallFunctionAndReturnEmptyString()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<StringRemoteValue>());
        Assert.That(((StringRemoteValue)response.AsSuccess().Result).Value, Is.Empty);
    }
    ...
    public async Task CanCallFunctionAndReturnNonEmptyString()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<StringRemoteValue>());
        Assert.That(((StringRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo("whoa"));
    }
    ...
    public async Task CanCallFunctionAndReturnRecentDate()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<DateRemoteValue>());
        Assert.That(response.AsSuccess().Result, Is.EqualTo(new DateRemoteValue(PinnedDateTimeString)));
    }
    ...
    public async Task CanCallFunctionAndReturnUnixEpoch()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<DateRemoteValue>());
        Assert.That(response.AsSuccess().Result, Is.EqualTo(new DateRemoteValue(EpochString)));
    }
    ...
    public async Task CanCallFunctionAndReturnNumberFive()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<NumberRemoteValue>());
        Assert.That(((NumberRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo(5));
    }
    ...
    public async Task CanCallFunctionAndReturnNumberZero()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<NumberRemoteValue>());
        Assert.That(((NumberRemoteValue)response.AsSuccess().Result).Value, Is.Zero);
    }
    ...
    public async Task CanCallFunctionAndReturnNumberNegativeZero()
    {
        ...
        var actualNumberValue = ((NumberRemoteValue)response.AsSuccess().Result).Value;
    ...
    public async Task CanCallFunctionAndReturnNumberPositiveInfinity()
    {
        ...
        var expectedInfinity = ((NumberRemoteValue)response.AsSuccess().Result).Value;
    ...
    public async Task CanCallFunctionAndReturnRegExp()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<RegExpRemoteValue>());
        Assert.That(response.AsSuccess().Result, Is.EqualTo(new RegExpRemoteValue(new RegExpValue("foo*") { Flags = "g" })));
    }
    ...
    public async Task CanCallFunctionAndReturnArray()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<ArrayRemoteValue>());
        Assert.That(((ArrayRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo(expectedArray.Value));
    }
    ...
    public async Task CanCallFunctionAndReturnObject()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<ObjectRemoteValue>());

        var expected = new ObjectRemoteValue
        {
            Value = [[new StringRemoteValue("objKey"), new StringRemoteValue("objValue")]]
        };
        Assert.That(((ObjectRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo(expected.Value));
    }
    ...
    public async Task CanCallFunctionAndReturnMap()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<MapRemoteValue>());
        Assert.That(((MapRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo(expected.Value));
    }
    ...
    public async Task CanCallFunctionAndReturnSet()
    {
        ...
        Assert.That(response.AsSuccess().Result, Is.AssignableTo<SetRemoteValue>());
        Assert.That(((SetRemoteValue)response.AsSuccess().Result).Value, Is.EqualTo(expected.Value));
    }
}
